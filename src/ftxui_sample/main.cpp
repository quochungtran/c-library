...
// configuration step. It creates a namespace called `c_library`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", c_library::cmake::project_name, c_library::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", c_library::cmake::project_version);
      return EXIT_SUCCESS;
    }
